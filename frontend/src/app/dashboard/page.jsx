            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Track your part-time job income, allowances, and student
                    expenses
                  </p>
                  <Link href="/budget-planner" className="no-underline">
                    <motion.div
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Save for that laptop, trip, or emergency fund with visual
                    progress
                  </p>
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Ask questions about budgeting, investing, or any financial
                    topic
                  </p>
