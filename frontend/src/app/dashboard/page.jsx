...
export default function Dashboard() {
  ...
  useEffect(() => {
    const fetchBadges = async () => {
      ...
      if (
        !dashboard ||
        !Array.isArray(dashboard.badges) ||
  ...
  const recentLessons = modules
    ? modules
        .filter(
          (module) =>
            module.userProgress?.status === "in_progress" ||
            module.userProgress?.status === "completed" ||
            (dashboard?.progress?.currentModule &&
              module._id === dashboard.progress.currentModule._id),
        )
        .map((module, index) => ({
          id: module._id || index,
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-lg p-2 mb-6 shadow-sm">
                <div className="flex space-x-1">
                  {["Learn", "Budget", "Goals", "AI Mentor"].map(
                    (tab, index) => (
                      <button
                        key={index}
                      ...
                      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        ...
                        <div className="space-y-4">
                          {recentLessons.map((lesson, index) => (
                            ...
                            >
                              <div
                                className={`bg-gray-50 dark:bg-gray-700 rounded-lg p-4 flex items-center justify-between border dark:border-gray-600 ${
                                  lesson.isCompleted
                          ...
                          {badges.map((badge, index) => (
                            ...
                            >
                              ...
                              >
                                ...
                                <p
                                  className={`text-xs font-medium ${badge.earned ? "text-yellow-800 dark:text-yellow-200" : "text-gray-500 dark:text-gray-400"}`}
                                >
                                  {badge.name}
                                </p>
                                {badge.description && (
                                  <p
                                    className={`text-xs mt-1 ${badge.earned ? "text-yellow-700 dark:text-yellow-300" : "text-gray-400 dark:text-gray-500"}`}
                                  >
                                    {badge.description}
                                  </p>
                                )}
                        ...
                        <div className="text-center">
                          ...
                          <div className="bg-gray-200 dark:bg-gray-600 rounded-full h-2 mb-2">
                            <div
                              ...
                              style={{
                                width: `${Math.min((userStats.streak / 7) * 100, 100)}%`,
                              }}
                            />
                          </div>
                          <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">
                            {userStats.streak}/7 days completed
                          </p>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    ...
                    {dashboard?.budget ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                            ...
                            <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                              ${dashboard.budget.remainingBudget}
                            </p>
                          </div>
                        </div>
                        <div className="text-center">
                      ...
                      <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-4">
                          Track your part-time job income, allowances, and
                          student expenses
                        </p>
                        <Link href="/budget-planner" className="no-underline">
                          <motion.div
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    ...
                    {dashboard?.goals && dashboard.goals.length > 0 ? (
                        ...
                        {dashboard.goals.map((goal, index) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-gray-600 dark:text-gray-300 text-sm">
                                {Math.floor(goal.progressPercentage)}%
                              </span>
                            </div>
                          </motion.div>
                        ))}
                      ...
                      <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-4">
                          Save for that laptop, trip, or emergency fund with
                          visual progress
                        </p>
                        <Link href="/goals" className="no-underline">
                          <motion.div
              ...
              <TabPanel value={tabValue} index={3}>
                ...
                >
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-6">
                      Get personalized advice and quick answers
                    </p>
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 mb-4">
                        Ask questions about budgeting, investing, or any
                        financial topic
                      </p>
