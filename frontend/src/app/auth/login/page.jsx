      ...
      <section className="container mx-auto px-4 py-16 text-center">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 font-medium text-sm mb-8"
          >
            🎓 Built for Students
          </motion.div>
          <motion.h1
          ...
          >
            Learn financial literacy through interactive lessons, gamified
            challenges, and AI-powered guidance. Perfect for students ready to
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        >
          {[
            ...
            {
              icon: (
                <Trophy className="w-12 h-12 text-purple-600 dark:text-purple-400 mb-4" />
              ),
            ...
            {
              icon: (
                <Bot className="w-12 h-12 text-indigo-600 dark:text-indigo-400 mb-4" />
              ),
              title: "AI Mentor",
              description:
            ...
            {
              icon: (
                <Users className="w-12 h-12 text-pink-600 dark:text-pink-400 mb-4" />
              ),
