...
export default function LessonPage() {
    ...
    const fetchModule = async () => {
      try {
        ...
        if (response.success) {
          ...
          setQuizAnswers(
            new Array(response.module.content.quiz?.length || 0).fill(null),
          );
  ...
  const progress =
    contentArray.length > 0
      ? ((currentStep + 1) / contentArray.length) * 100
      : 0;
  ...
  const completeModule = async () => {
    try {
      ...
      const response = await completeLessonModule(moduleId, {
        quizScore,
        timeSpent,
      });
        ...
        return (
          <div className="text-center py-8">
            ...
            >
              ...
              Launch{" "}
              {content.interactiveData?.type === "budget_planner"
                ? "Budget Planner"
                : "Tool"}
            </motion.button>
          </div>
      ...
      case "quiz":
        return (
          <div className="space-y-6">
            ...
            {!showQuizResult &&
              quizAnswers.every((answer) => answer !== null) && (
                <motion.button
        ...
        {!completed ? (
          <>
            ...
            >
              ...
              >
                {currentStep === contentArray.length - 1
                  ? "Complete Module"
                  : "Next"}
            ...
            <div className="p-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-lg mx-auto">
                ...
                <span className="font-semibold text-blue-600 dark:text-blue-400">
                  {completionData?.xpEarned || module.xpReward} XP
                </span>{" "}
                and completed {module.title}!
                {completionData?.newLevel && (
                  <>
                    <br />
                    <span className="inline-block mt-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-3 py-1 rounded-full text-sm font-medium">
