...
const GEMINI_API_URL =
  "https://assignment-backend-one-khaki.vercel.app/api/gemini/generate";
...
export const sendMessageToAI = async (
  ...
  return { message: data.content, sources: data.sources };
};
...
export const getLearningPath = async () => {
  ...
  const prompt =
    "Provide a structured learning path for personal finance topics";
